  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="sidenav-footer mx-3 ">
      <div class="card card-plain shadow-none" id="sidenavCard">
        <img class="w-50 mx-auto" src="{{asset('frontend/assets/img/illustrations/icon-documentation.svg')}}" alt="sidebar_illustration">
                ...
                <div class="card-header pb-0 p-3">
                  <div class="row">
                    ...
                    <div class="col-6 text-end">
                      <a class="btn bg-gradient-dark mb-0" href="{{  route('bank.create')}}"><i class="fas fa-plus"></i>&nbsp;&nbsp;Add New Card</a>
                    </div>
                  </div>
                </div>
                        ...
                        <div class="card bg-transparent shadow-xl">
                          <div class="overflow-hidden position-relative border-radius-xl" style="background-image:url('https://raw.githubusercontent.com/creativetimofficial/public-frontend/assets/master/argon-dashboard-pro/assets/img/card-visa.jpg');">
                            ...
                            <div class="card-body position-relative z-index-1 p-3">
                              ...
                              <h5 class="text-white mt-4 mb-5 pb-2">{{ $data->jenis_bank}}</h5>
                              <div class="d-flex">
                                <div class="d-flex">
                                  <div class="me-4">
                                ...
                                <div class="ms-auto w-20 d-flex align-items-end justify-content-end">
                                  <img class="w-60 mt-2" src="{{asset('frontend/assets/img/logos/mastercard.png')}}" alt="logo">
                                </div>
                              </div>
                            </div>
                          </div>
